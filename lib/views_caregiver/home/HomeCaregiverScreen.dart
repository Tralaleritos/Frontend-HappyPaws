...
import '../../data/models/pet.dart' as pet_model;
import '../../data/service/ApiService.dart' as service;
import '../search/RecomendationPetDetail/PetDetailScreen.dart';
import '../search/SearchCaregiverScreen.dart';
...
class _HomeCaregiverScreenState extends State<HomeCaregiverScreen> {
  String _currentAddress = "Av. la marina San...";
          ...
          Column(
            ...
            children: [
              Text(
                ...
                '¡Hola, ${user != null && user.names != null && user.names.isNotEmpty ? user.names : "Usuario"}!',
