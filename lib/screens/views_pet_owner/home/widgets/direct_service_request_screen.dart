  ...
  Future<void> _getCurrentLocation() async {
    ...
    try {
      ...
      setState(() {
        ...
        _latitudeController.text = _locationLatitude!.toStringAsFixed(6);
        _longitudeController.text = _locationLongitude!.toStringAsFixed(6);
      });

      print('✅ Ubicación obtenida: $_locationName (Lat: $_locationLatitude, Lng: $_locationLongitude)');
    } catch (e) {
