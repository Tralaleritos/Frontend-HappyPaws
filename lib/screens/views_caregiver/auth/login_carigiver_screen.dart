...
class LoginCarigiverScreen extends StatefulWidget {
  final Function? onLoginSuccess;

  const LoginCarigiverScreen({
    super.key,
    this.onLoginSuccess,
  });

  @override
  State<LoginCarigiverScreen> createState() => _LoginScreenState();
}

class _LoginScreenState extends State<LoginCarigiverScreen> {
  ...
  Future<void> _signInWithEmailAndPassword() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (user != null) {
          // Si el usuario existe, navegar al home
          if (mounted) {
            widget.onLoginSuccess?.call(); // Llamar al callback si está presente
                              ...
                              children: [
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    errorStyle: const TextStyle(height: 0, fontSize: 0), // Ocultar el error predeterminado
                                  ),
                                  validator: (value) {
